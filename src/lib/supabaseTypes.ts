...
export interface ImageDB {
  ...
  country?: string,  // Added for writer country
  short_description?: string,  // Added for writer short description
  detailed_description?: string,  // Added for writer detailed description
